...
:: Shim-only mod: removes xinput1_3.dll from Build\Final, restoring
:: Build\Final\xinput1_3.dll.backup if we created one on first install.
:: /force is a no-op (no loader to remove beyond the shim).
